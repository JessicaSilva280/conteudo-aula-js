...
let frase = 'Eu amo coxinha. Coxinha é o melhor salgado da terra. Coxinha é nota mil.';

frase = frase.replaceAll('Coxinha', 'Risole');
frase = frase.replaceAll('coxinha', 'risole');
...
let nome = 'Jéssica Santos';
let exEndsWith = nome.endsWith('Santos');
